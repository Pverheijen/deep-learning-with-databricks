...
# MAGIC 
# MAGIC More information can be found [here](https://pytorch.org/tutorials/beginner/basics/data_tutorial.html#creating-a-custom-dataset-for-your-files).
...
# MAGIC 
# MAGIC If you wanted to use custom logic, you would inherit from `nn.Module` and override the `forward` method. More information can be found [here](https://pytorch.org/docs/stable/generated/torch.nn.Module.html).
# MAGIC 
