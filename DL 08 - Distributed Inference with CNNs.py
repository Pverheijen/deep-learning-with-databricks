...
img_paths = [
    f"{datasets_dir}/img/pug.jpg".replace("dbfs:/", "/dbfs/"), 
    f"{datasets_dir}/img/strawberries.jpg".replace("dbfs:/", "/dbfs/"), 
    f"{datasets_dir}/img/rose.jpg".replace("dbfs:/", "/dbfs/")
]
...
df = spark.read.format("binaryFile").load(f"{datasets_dir}/img/founders/")
display(df)
