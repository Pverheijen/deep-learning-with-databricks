...
training_data = CoNLL().readDataset(spark, f"{datasets_dir}/sec-fillings/train-fin5.txt", read_as="text")
display(training_data)

# COMMAND ----------

test_data = CoNLL().readDataset(spark, f"{datasets_dir}/sec-fillings/test-fin3.txt", read_as="text")
