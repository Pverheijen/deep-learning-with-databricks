...
explainer = LimeTabularExplainer(X_train, feature_names=X.columns, mode="regression")
...
pd.DataFrame(X_test[0], X.columns, ["features"])
...
shap_features = pd.DataFrame(shap_values[0][0], X.columns, ["features"])
